...
Diferencia de la arquitectura bidireccional donde el servidor y el cliente pueden intercambiarse 
mensajes en imfroación en tiempo real sin esperar que el cliente envié una petición para ser respondida.

Arquitectura bidireccional | Tiempo real
Esta es una de las últimas arquitecturas empleadas en el protocolo de las REST API's para 
el intercambio de datos en tiempo real entre cliente y servidor, donde también se utilizan
técnicas de broadcast donde enviamos mensajes o datos a una cantidad indefinida de clientes.
